...
public class CartTest {
    ...
    private void assertCartContainsNQuantityForProduct(List<CartLine> lines, String productId, int expectedQty) {
        assertThat(lines)
    ...
    @Test
    void itExposeColectedItemsWithQuantity(){
        Cart cart=Cart.empty();
        String productId1=thereIsProduct(PRODUCT_1);
        String productId2=thereIsProduct(PRODUCT_2);
